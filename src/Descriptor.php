...
{
    /**
     * The class fqn for the object.
     *
     * NOTE: In the case of a proxy, the enhancer for the system
     *       that issued the proxy should set this descriptor with
     *       highest priority.
     */
    const CLASS_FQN = 'class_fqn';
