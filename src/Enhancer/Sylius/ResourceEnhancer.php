...
namespace Symfony\Cmf\Component\Description\Enhancer\Sylius;
...
class ResourceEnhancer implements DescriptionEnhancerInterface
{
    ...
    {
        $metadata = $this->registry->getByClass($description->get(Descriptor::CLASS_FQN));
        $payload = $description->getObject();
    ...
    {
        try {
            $this->registry->getByClass($description->get(Descriptor::CLASS_FQN));
